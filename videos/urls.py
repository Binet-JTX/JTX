...
urlpatterns = [
    ...
    url(r'^projs/(?P<page>[0-9]+)/$', views.projs, name='projs_page'),
    url(r'^projs/$', views.projs, name='projs'),
    url(r'^proj/(?P<proj_id>[0-9]+)/$', views.proj, name='proj'),
    url(r'^categories/$', views.categories, name='categories'),
    url(r'^category/(?P<category_id>[0-9]+)/$', views.category, name='category'),
    url(r'^videos/(?P<page>[0-9]+)/$', views.videos, name='videos_page'),
    url(r'^videos/$', views.videos, name='videos'),
    url(r'^video/(?P<video_id>[0-9]+)/$', views.video, name='video'),
    url(r'^favorites/(?P<page>[0-9]+)/$', views.favorites, name='favorites_page'),
